      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="credit card">online banking</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" required placeholder="e.g. Federal Territory of Kuala Lumpur">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" min="0" name="pin_code" required placeholder="">
         </div>
      </div>
